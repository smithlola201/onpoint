...
const DebitCard = ({ cardNumber = '**** **** **** 7890', cardHolder = 'JAMES ANDERSON', expiryDate = '12/28', cvv = '***' }: DebitCardProps) => {
  ...
  return (
    <div
      className="bg-[#18819d] relative shadow-sm rounded-2xl p-6 pt-4 cursor-pointer transition-all duration-300 ease-out transform-style-3d"
      style={{
    ...
    >
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <div className="flex items-center gap-2">
          <Image src="https://i.postimg.cc/nh9nPDgj/store-logo-1034057.png" width={72} height={72} className="" alt="logo" />
        </div>
