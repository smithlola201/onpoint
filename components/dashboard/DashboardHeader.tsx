...
export default function DashboardHeader() {
  ...
  return (
    <header className="pb-6 animate-fade-up">
      <div className="flex p-5 py-2 items-center border-b border-b-[#18819d] bg-white justify-between">
      ...
      <Image src="https://i.imgur.com/pq0wX3g.png" width={230} height={28} className="w-[100px]" alt="logo" />
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 bg-[#18819d] rounded-full border-2 border-card" />
          </Link> */}
